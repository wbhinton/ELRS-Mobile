...
## Do I need an internet connection or cellular service at the field?
...
ELRS Mobile natively handles forced network routing. It ensures your phone doesn't silently switch back to 5G/LTE when it realizes the receiver's hotspot has no internet access, completely eliminating the common "connected but can't see the receiver" issue out in the field [1, 2].
