...
mixin _$FlashingState implements DiagnosticableTreeMixin {
 ...
 String? get selectedDeviceType; String? get selectedVendor; String? get selectedFrequency; TargetDefinition? get selectedTarget; String? get selectedVersion; FlashingStatus get status; double get progress; FlashError? get error; String get bindPhrase; String get wifiSsid; String get wifiPassword; int get regulatoryDomain; int get wifiOnInterval; String? get autosavingField; FieldValidationError? get bindPhraseError; FieldValidationError? get wifiSsidError; FieldValidationError? get wifiPasswordError; Uint8List? get cachedPayload;
...
@useResult
$Res call({
 String? selectedDeviceType, String? selectedVendor, String? selectedFrequency, TargetDefinition? selectedTarget, String? selectedVersion, FlashingStatus status, double progress, FlashError? error, String bindPhrase, String wifiSsid, String wifiPassword, int regulatoryDomain, int wifiOnInterval, String? autosavingField, FieldValidationError? bindPhraseError, FieldValidationError? wifiSsidError, FieldValidationError? wifiPasswordError, Uint8List? cachedPayload
});
...
as FlashError?,bindPhrase: null == bindPhrase ? _self.bindPhrase : bindPhrase // ignore: cast_nullable_to_non_nullable
...
as FieldValidationError?,cachedPayload: freezed == cachedPayload ? _self.cachedPayload : cachedPayload // ignore: cast_nullable_to_non_nullable
as Uint8List?,
  ));
}
/// Create a copy of FlashingState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? selectedDeviceType,  String? selectedVendor,  String? selectedFrequency,  TargetDefinition? selectedTarget,  String? selectedVersion,  FlashingStatus status,  double progress,  FlashError? error,  String bindPhrase,  String wifiSsid,  String wifiPassword,  int regulatoryDomain,  int wifiOnInterval,  String? autosavingField,  FieldValidationError? bindPhraseError,  FieldValidationError? wifiSsidError,  FieldValidationError? wifiPasswordError,  Uint8List? cachedPayload)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FlashingState() when $default != null:
return $default(_that.selectedDeviceType,_that.selectedVendor,_that.selectedFrequency,_that.selectedTarget,_that.selectedVersion,_that.status,_that.progress,_that.error,_that.bindPhrase,_that.wifiSsid,_that.wifiPassword,_that.regulatoryDomain,_that.wifiOnInterval,_that.autosavingField,_that.bindPhraseError,_that.wifiSsidError,_that.wifiPasswordError,_that.cachedPayload);case _:
  return orElse();
...
@override final  FlashError? error;
