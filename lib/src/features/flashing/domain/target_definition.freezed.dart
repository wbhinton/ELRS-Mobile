...
@JsonKey(name: 'upload_methods') List<String> get uploadMethods; List<String> get options; String get category;@JsonKey(name: 'device_type') String get deviceType;@JsonKey(name: 'frequency_type') String get frequencyType;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,vendor,name,productCode,firmware,const DeepCollectionEquality().hash(config),platform,const DeepCollectionEquality().hash(uploadMethods),const DeepCollectionEquality().hash(options),category,deviceType,frequencyType);

@override
String toString() {
  return 'TargetDefinition(vendor: $vendor, name: $name, productCode: $productCode, firmware: $firmware, config: $config, platform: $platform, uploadMethods: $uploadMethods, options: $options, category: $category, deviceType: $deviceType, frequencyType: $frequencyType)';
}
...
@useResult
$Res call({
 String vendor, String name,@JsonKey(name: 'product_code') String? productCode, String? firmware, Map<String, dynamic> config, String? platform,@JsonKey(name: 'upload_methods') List<String> uploadMethods, List<String> options, String category,@JsonKey(name: 'device_type') String deviceType,@JsonKey(name: 'frequency_type') String frequencyType
});
...
/// Create a copy of TargetDefinition
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? vendor = null,Object? name = null,Object? productCode = freezed,Object? firmware = freezed,Object? config = null,Object? platform = freezed,Object? uploadMethods = null,Object? options = null,Object? category = null,Object? deviceType = null,Object? frequencyType = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String vendor,  String name, @JsonKey(name: 'product_code')  String? productCode,  String? firmware,  Map<String, dynamic> config,  String? platform, @JsonKey(name: 'upload_methods')  List<String> uploadMethods,  List<String> options,  String category, @JsonKey(name: 'device_type')  String deviceType, @JsonKey(name: 'frequency_type')  String frequencyType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TargetDefinition() when $default != null:
return $default(_that.vendor,_that.name,_that.productCode,_that.firmware,_that.config,_that.platform,_that.uploadMethods,_that.options,_that.category,_that.deviceType,_that.frequencyType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String vendor,  String name, @JsonKey(name: 'product_code')  String? productCode,  String? firmware,  Map<String, dynamic> config,  String? platform, @JsonKey(name: 'upload_methods')  List<String> uploadMethods,  List<String> options,  String category, @JsonKey(name: 'device_type')  String deviceType, @JsonKey(name: 'frequency_type')  String frequencyType)  $default,) {final _that = this;
switch (_that) {
case _TargetDefinition():
return $default(_that.vendor,_that.name,_that.productCode,_that.firmware,_that.config,_that.platform,_that.uploadMethods,_that.options,_that.category,_that.deviceType,_that.frequencyType);case _:
  throw StateError('Unexpected subclass');
...
class _TargetDefinition extends TargetDefinition {
  const _TargetDefinition({required this.vendor, required this.name, @JsonKey(name: 'product_code') this.productCode, this.firmware, final  Map<String, dynamic> config = const {}, this.platform, @JsonKey(name: 'upload_methods') final  List<String> uploadMethods = const [], final  List<String> options = const [], this.category = '', @JsonKey(name: 'device_type') this.deviceType = 'RX', @JsonKey(name: 'frequency_type') this.frequencyType = '2.4GHz'}): _config = config,_uploadMethods = uploadMethods,_options = options,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,vendor,name,productCode,firmware,const DeepCollectionEquality().hash(_config),platform,const DeepCollectionEquality().hash(_uploadMethods),const DeepCollectionEquality().hash(_options),category,deviceType,frequencyType);
...
/// Create a copy of TargetDefinition
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? vendor = null,Object? name = null,Object? productCode = freezed,Object? firmware = freezed,Object? config = null,Object? platform = freezed,Object? uploadMethods = null,Object? options = null,Object? category = null,Object? deviceType = null,Object? frequencyType = null,}) {
