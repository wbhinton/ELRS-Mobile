...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
  <div class="p-5 rounded-2xl bg-primary/5 border border-primary/20 backdrop-blur-sm">
    <div class="flex items-center gap-2 mb-3 text-primary">
      ...
      <h3 class="text-lg font-bold m-0 italic">Ondersteund</h3>
    </div>
    <ul class="space-y-2 text-sm text-text-muted list-none pl-0 m-0">
      <li class="flex gap-2"><span>•</span> Alle ESP8285, ESP32, ESP32-C3 en ESP32-S3 targets</li>
      <li class="flex gap-2"><span>•</span> Wi-Fi-compatibele ontvangers en zenders</li>
      <li class="flex gap-2"><span>•</span> ELRS Versies 3.3.x en 4.x</li>
    </ul>
  </div>
...
## Geteste Hardware
De volgende hardware targets zijn expliciet getest met ELRS Mobile:
